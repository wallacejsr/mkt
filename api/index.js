...
function buildRawEmailHtml(textBody, visualStyle = 'simple', ctaText = '', ctaUrl = '') {
  const paragraphs = String(textBody || '').split(/\n{2,}/).filter(Boolean)
    ...
    .join('');
  const header = visualStyle === 'simple' ? '' : '<tr><td style="padding:22px 0 18px 0"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="font-family:Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:bold;color:#17324d">AGRO <span style="color:#5b3df5">BW</span></td><td align="right" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:16px;font-weight:bold;letter-spacing:.5px;color:#64748b">MARKETPLACE DO AGRONEGÓCIO</td></tr></table></td></tr><tr><td height="3" bgcolor="#5b3df5" style="height:3px;line-height:3px;font-size:0">&nbsp;</td></tr>';
  const cta = visualStyle === 'cta' ? `<table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr><td bgcolor="#5b3df5" style="border-radius:5px"><a href="${escapeEmailHtml(ctaUrl)}" style="display:inline-block;padding:12px 20px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:bold;line-height:18px;color:#ffffff;text-decoration:none">${escapeEmailHtml(ctaText)}</a></td></tr></table><table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr><td height="22" style="height:22px;line-height:22px;font-size:0">&nbsp;</td></tr></table>` : '';
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center"><table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:600px">${header}<tr><td style="padding:${visualStyle === 'simple' ? '0' : '26px 0 0 0'};font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;color:#1f2937">${paragraphs}${cta}</td></tr></table></td></tr></table>`;
}
