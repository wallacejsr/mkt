...
const buildEmailHtml = (textBody: string, visualStyle: EmailVisualStyle, ctaText: string, ctaUrl: string) => {
  ...
  const cta = visualStyle === 'cta' ? `<table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr><td bgcolor="#5b3df5" style="border-radius:5px"><a href="${escapeHtml(ctaUrl)}" style="display:inline-block;padding:12px 20px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:bold;line-height:18px;color:#ffffff;text-decoration:none">${escapeHtml(ctaText)}</a></td></tr></table><table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr><td height="22" style="height:22px;line-height:22px;font-size:0">&nbsp;</td></tr></table>` : '';
